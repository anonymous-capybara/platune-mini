...
# from https://github.com/acids-ircam/AFTER/blob/main/after/diffusion/networks/rotary_embedding.py"""
# and https://github.com/lucidrains/rotary-embedding-torch/blob/main/rotary_embedding_torch/rotary_embedding_torch.py"""
